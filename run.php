...
while( $line !== FALSE ) {
    ...
    if( $line == 'quit' || $line == 'exit' ) {
        ...
        run_api('qruqsp.systemdocs.update', '&package=qruqsp');
        run_api('qruqsp.systemdocs.toolsDupErrors', '&package=qruqsp');
    }
    else if( $line == 'lerr' ) {
        run_api('qruqsp.systemdocs.update', '&package=qruqsp');
        run_api('qruqsp.systemdocs.errors', '&package=qruqsp&limit=1');
    }
